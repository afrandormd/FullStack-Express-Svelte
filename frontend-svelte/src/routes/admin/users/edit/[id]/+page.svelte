        ...
        <div class="card-body">
          <form method="POST" action="?/update" use:enhance>
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" name="name" class="form-control {form?.errors?.some((e) => e.path === 'name') ? 'is-invalid' : ''}" 
            ...
            <div class="form-group mb-3">
              ...
              <input type="email" name="email" class="form-control {form?.errors?.some((e) => e.path === 'email') ? 'is-invalid' : ''}" 
            ...
            <div class="form-group mb-3">
              ...
              <input type="password" name="password" class="form-control {form?.errors?.some((e) => e.path === 'password') ? 'is-invalid' : ''}" 
                placeholder="Password"
                value={form?.values?.password ?? data.user?.password ?? ''}
              />
